		...
		<div class="row">
			<div class="col-lg-3">
				<ul class="infor-nav">
					...
					<li><a href="<?php echo U('Personal/upload_headpho');?>">头像</a></li>
			...
			<div class="col-lg-9">
				<form  action="<?php echo U('Personal/updateInfo');?>" method="POST" class="form_wd_23" enctype="multipart/form-data">
				    <fieldset id="inforForm">
				      <div id="legend" class="">
				        <legend class="form-title">账户信息</legend>
				      </div>
				    <div class="control-group">
				          ...
				          <div class="controls">
					          <input class="input-xlarge" name="user_name"  value="<?php echo (session('username')); ?>">
						  </div>
				    </div>
				    <div class="control-group">
				          ...
				          <div class="controls">
					          <input class="input-xlarge" name="user_pwd" type="password" value="<?php echo ($client_info["user_pwd"]); ?>">
						  </div>
				    </div>
				    </fieldset>
				    <br />
				    <!-- 个人信息 -->
				    <fieldset id="inforForm2">
				    <div id="legend" class="">
       				 	<legend class="form-title">个人信息</legend>
      				</div>
				    <div class="control-group">
				          ...
				          <div class="controls">
				            <input type="text" placeholder="" class="input-xlarge" required="required" name="real_name" value="<?php echo ($client_info["real_name"]); ?>" >
				            <p class="help-block">您的公开个人资料将仅显示您的名字。申请预订时，房东会看到您的名字和姓氏。</p>
				          </div>
				        </div>
				    ...
				    <div class="control-group">
					    <label class="control-label">性别</label>
					        <div class="controls">
						      <!-- Multiple Radios -->
						      <label class="radio" id="radio-button" >
						        <input type="radio" value="男" name="group" checked="checked" name="sex" value="<?php echo ($client_info["dates"]); ?>">
						        男
						      </label>
						      <label class="radio" id="radio-button">
						        <input type="radio" value="女" name="group" name="sex" value="<?php echo ($client_info["dates"]); ?>">
						        女
						      </label>
						    </div>			
					</div>
				    <div class="control-group">
				          ...
				          <div class="controls">
				           <input id="date" type="date" name="dates" value="<?php echo ($client_info["dates"]); ?>"> 
				          </div>
				    ...
				    <div class="control-group">
				          ...
				          <div class="controls">
				            <input id="email" type="email" placeholder="ihome@gmail.com" class="input-xlarge" name="email_address" value="<?php echo ($client_info["email_address"]); ?>" >
				            <p class="help-block">此数据仅用于分析，我们不会透露给其它用户</p>
				          </div>
				        </div>
				    ...
				    <div class="control-group">
				          ...
				          <div class="controls">
				            <input id="tel" type="tel" placeholder="18812312341" class="input-xlarge" name="tel" value="<?php echo ($client_info["tel"]); ?>">
				            <p class="help-block">只有在您和另一名iHome用户确认预订时，此资料才会被分享。</p>
				          </div>
				        </div>
				    ...
				    <div class="control-group">
				          ...
				          <div class="controls">
				            <input type="text" placeholder="" class="input-xlarge" required="required" name="address" value="<?php echo ($client_info["address"]); ?>" >
				    ...
				    <!-- <div class="control-group">
				          ...
				          <div class="controls">
				            <div class="textarea">
				                  <textarea type="text" class="" name="cv" > </textarea>
				            </div>
				          </div>
				    </div> -->
				        <button type="submit" class="btn btn-success waves-effect">提交</button>
				    </fieldset>
