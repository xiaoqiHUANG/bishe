	...
	<div class="price">
		...
		<div class="price-grid">
				...
				<ul>
					<li>
						<select class="in-drop" id="lowPrice">
									<option>最低</option>
									<option>0</option>
									<option>100元/月</option>
									<option>200元/月</option>
									<option>300元/月</option>
									<option>400元/月</option>
									<option>500元/月</option>
									<option>600元/月</option>
									<option>700元/月</option>
									<option>800元/月</option>
									<option>900元/月</option>
									<option>1000元/月</option>
									<option>1500元/月</option>
									<option>2000元/月</option>
								</select>
					</li>
					<span>-</span>
					<li>
			...
			<div class="col-sm-3 price-top1">
				<h4>租房月份</h4>
				<select class="in-drop" id="rentMonth">
							<option>1个月</option>
							<option>2个月</option>
							<option>3个月</option>
							<option>4个月</option>
			...
			<div class="col-sm-3 price-top1">
				<button type="button" class="btn btn-success btn-block" id="searchLongRoom">搜索房源</button>
				<!--<h4>住房人数</h4>
						<select class="in-drop">
							<option>不限</option>
							<option>1人</option>
						...
						<div class="grid-lo">
							<a href="buy_single.html">
								<figure class="effect-layla">
									<img class=" img-responsive" src="/bisheServer/Public/images/ce.jpg" alt="img06">
									<figcaption>
										<h4>London</h4>
						...
						<div class="grid-me">
							<div class="col-md-8 grid-lo1">
								<div class=" grid-lo">
									<a href="buy_single.html">
										<figure class="effect-layla">
											<img class=" img-responsive" src="/bisheServer/Public/images/ce2.jpg" alt="img06">
											<figcaption>
						...
						<div class="grid-me">
							<div class="col-md-6 grid-lo3">
								<div class=" grid-lo">
									<a href="buy_single.html">
										<figure class="effect-layla">
											<img class="img-responsive" src="/bisheServer/Public/images/ce4.jpg" alt="img06">
											<figcaption>
...
<script type="__PUBLIC_/text/javascript" src="/bisheServer/Public/js/jquery.flexisel.js"></script>
<!--footer-->
<div class="footer">
	<div class="container">
