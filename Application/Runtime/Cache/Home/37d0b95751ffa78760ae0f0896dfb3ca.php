...
<body>
	...
	<div class="navigation">
		<div class="container-fluid">
			<nav class="pull">
				<ul>
					<li><a  href="<?php echo U('Index/personal');?>">个人主页</a></li>
					<li><a  href="#">收件箱</a></li>
...
<div class="asked">
	<div class="container">
		<div class="row">
			<div class="col-lg-3 ">
				<ul class="infor-nav">
					<li><a href="<?php echo U('Personal/edit_message');?>">编辑个人资料</a></li>
			...
			<div class="col-lg-9">
				<form class="form-horizontal" id="infor-form">
				    <fieldset>
				      <div id="legend" class="">
				        <legend class="form-title">我收到的评价</legend>
				      </div>
				      		<div class="list-group">
									<a href="#" class="list-group-item">
										<img class="circle_pro" src="/bishe/Public/images/profile.jpg" />
										<p>用户名</p>
									...
									<a href="#" class="list-group-item">
							            ...
							            <br/>
							            发布人：<<?php echo ($vo["author"]); ?>>
							            <br/>
							            发布时间：<<?php echo ($vo["rtime"]); ?>>
							            <br/>
							            发布内容：<<?php echo ($vo["content"]); ?>>
									</a>
									<a href="#" class="list-group-item">
