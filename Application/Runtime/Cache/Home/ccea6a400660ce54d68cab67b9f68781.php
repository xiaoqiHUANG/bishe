...
<link rel="stylesheet" href="/bishe/Public/css/register.css" />
...
<div class="login-right">
	<div class="container">
		...
		<div class="login-top">
				...
				<div class="form-info">
					<form role="form" action="/bishe/Home/Login/checkLogin" method="post" enctype="application/x-www-form-urlencoded">
